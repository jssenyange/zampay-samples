...
$req = 'Cmd=VerifyMpn&ApiKey=' . $API_Key . '&ApiPassword=' . $API_Password ;
...
if(!$res){
    ...
    if($api_response == null || $api_response->Status != 200){        
        ...
        echo ("<p><h3>MPN Verification failed</h3></p>");
    ...
    ' Status of the payment: 
            'Paid: The payment has been made, and the funds have been added successfully to your account. 
            
    '********************************************************************************************************************
    '
    ' THE PARTNER SHOULD SAVE THE KEY TRANSACTION RELATED INFORMATION LIKE 
    '                    TransactionId, TransactionDate etc
    ...
    */
    ...
    if( $payment_status == 'Paid' ){
        ...
        // This is for illustrations only.
        // Dont use the code below.
        // instead Store and update your database accordingly
        $json_orders = json_decode(file_get_contents('orders.txt'), true);
        $json_orders[$order_number]='Paid';
        file_put_contents('orders.txt', json_encode($json_orders));
